...
public class JwtHandler {
    ...
    public JwtHandler(IConfiguration configuration, UserManager<BaseballUser> userManager) {
        _configuration = configuration;
        _userManager = userManager;
    }

    public async Task<JwtSecurityToken> GetTokenAsync(BaseballUser user) =>
        new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(BaseballUser user) {
